...
[![Profile Views](https://komarev.com/ghpvc/?username=s-anuj1&color=008080&style=for-the-badge&label=PROFILE+VIEWS)](https://github.com/s-anuj1)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/anuj-kumar-1aa590230/)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:anuj.product.iitr@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sainianuj07)
...
- 📬 Reach me at **anuj.product.iitr@gmail.com**
...
### 🔭 Ask My Doc
An **LLM-powered semantic document reader** that splits documents into semantic chunks, embeds them with advanced vector models, and queries them intelligently using the **Gemini API + ChromaDB**. Think of it as Ctrl+F — but it actually understands your question.

**Live on Streamlit Cloud** → [Try it here](https://upload-and-ask-my-docs.streamlit.app/)
...
|:---|:---|:---|
| **Ask My Doc** | Semantic RAG document reader — upload any doc, ask questions in plain English, get precise answers. Deployed live on Streamlit Cloud. | Python · Gemini API · ChromaDB · Streamlit |
| **Workflow Automation Suite** | Custom automation pipelines for business ops — CRM syncs, multi-step triggers, and cross-platform data flows built at Igniflo. | Make.com · Airtable · REST APIs |
| **Flipkart APM Case — Boredom by Design** | Designed *REFBORE*, a mindfulness app to restore productive boredom — from problem framing to wireframes. Flipkart APM challenge submission. | User Persona · Problem Framing · Market Sizing · Competitive Analysis · Wireframing · North Star Metric · Metrics Design · Value Proposition |
| **YouTube Music — Recommendations System** | Diagnosed drop-off in YT Music engagement and redesigned the recommendation engine strategy with full metrics & experimentation framework. | User Research · Problem Framing · Feature Prioritization (RICE) · A/B Testing · Funnel Analysis · North Star Metric · KPI Design · Whimsical |
| **Meesho — Trust-Driven Shopping** | Built a trust framework for Meesho's social commerce platform — multi-tier seller verification, AI-powered quality scoring, and quantified business impact. | User Persona · Problem Framing · Solution Design · Value Proposition · Metrics & Pitfalls · North Star Metric · Competitive Analysis · Quantitative Impact Analysis · Whimsical |
...
- **🏔️ Deputy Secretary, Himalayan Explorers' Club** — Led a team of 90+ students across 9 different verticals. Managed logistics and organizational finances for the club's operations.
- **🌾 Village Coordinator, Unnat Bharat Abhiyan @ IIT Roorkee** — Led a 20+ member team driving rural development across 500+ villagers through 10+ grassroots initiatives, bridging institutional resources with on-ground community needs.
- **🏛️ President, Hostel Council** — Directed housing administration and student welfare systems for an entire campus hostel.
- **🎨 Founder, Rajasthan's Cultural Association** — Established the association at IIT Roorkee and coordinated its inaugural flagship cultural program.
- **📷 Interests** — High-altitude Expeditions · Skiing · Skateboarding · Photography · Cycling
...
> ⚡ *Automate the boring · Measure what matters · Build things that actually work*
